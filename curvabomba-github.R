...
analisar_bomba <- function(Q, H, N, Hg) {
  ...
  # 1. AJUSTES INICIAIS COM OS VALORES DE ENTRADA ----
  ...
  # Corrigido: Agora puxa os dados de 'tabela_rendimento' para alinhar com a Seção 7
  ...
  # Estruturação da lista de retorno organizada
